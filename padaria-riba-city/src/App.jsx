          ...
          {pedidoConfirmado ? (
            ...
            <motion.div key="sobre" className="sobre-container" initial={{opacity:0, y:30}} animate={{opacity:1, y:0}} exit={{opacity:0, y:30}}>
              <div className="sobre-esquerda">
                <div className="card-da-loja"><img src="img/fachada-da-loja.png" alt="Fachada" className="img-fachada"/><div className="endereco-box"><MapPinIcon /><p>Rua Dr. Ricardo Gonçalves, 170</p></div></div>
              </div>
